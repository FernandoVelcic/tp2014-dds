...
public class HomeJugadores implements Serializable {
	...
	private Partido partido = new Partido(new Date(), new Administrador());
	...
	private HomeJugadores() {
		...
		partido.inscribirJugador(new Participante("Franco", "Pancho", new Date(), 6, new ArrayList<Calificacion>(Arrays.asList(calificacion3,calificacion4)), new ArrayList<Infraccion>(Arrays.asList())));
		partido.inscribirJugador(new Participante("Martin", "Tincho", new Date(), 8, new ArrayList<Calificacion>(Arrays.asList(calificacion10,calificacion6,calificacion8,calificacion6)), new ArrayList<Infraccion>(Arrays.asList(infraccion))));
		partido.inscribirJugador(new Participante("Oscar", "Osqui", new Date(), 9, new ArrayList<Calificacion>(Arrays.asList(calificacion10,calificacion9,calificacion9)), new ArrayList<Infraccion>(Arrays.asList(infraccion))));
		partido.inscribirJugador(new Participante("Fabian", "Fabi", new Date(), 10, new ArrayList<Calificacion>(Arrays.asList(calificacion10,calificacion10)), new ArrayList<Infraccion>(Arrays.asList())));
		partido.inscribirJugador(new Participante("Pablo", "Paul", new Date(), 5, new ArrayList<Calificacion>(Arrays.asList(calificacion9,calificacion6,calificacion3,calificacion5)), new ArrayList<Infraccion>(Arrays.asList(infraccion))));
		partido.inscribirJugador(new Participante("Jose", "Pepe", new Date(), 7, new ArrayList<Calificacion>(Arrays.asList(calificacion8)), new ArrayList<Infraccion>(Arrays.asList())));
	}
